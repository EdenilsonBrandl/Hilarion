...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 116;
...
const uint64_t MONEY_SUPPLY                                  = uint64_t(800000000000000000);
...
const uint64_t DIFFICULTY_TARGET                             = 225; // seconds
...
const int      P2P_DEFAULT_PORT                              = 12113;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 12114;
